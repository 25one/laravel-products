     ...
     <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="header" style="font-size: 15px;">GOODS</li>  
                <li>
                    <a href="<?php echo e(url('/')); ?>">
                        <i class="fa fa-folder-o"></i> <span>List of Googd</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <i class="fa fa-folder-o"></i> <span>Cart</span>
                    </a>
                </li>
            </ul>
        </section>
...
<?php /**PATH /home/alex/www/laravel-goods-group1/resources/views/good/layout.blade.php ENDPATH**/ ?>