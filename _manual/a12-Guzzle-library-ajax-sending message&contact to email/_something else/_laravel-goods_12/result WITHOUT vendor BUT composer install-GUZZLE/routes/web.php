...
Route::name('clearcart')->post('/clearcart', 'GoodController@clearcart');
Route::name('clearone')->post('/clearone', 'GoodController@clearone');
Route::name('toorder')->post('/toorder', 'GoodController@toorder');
