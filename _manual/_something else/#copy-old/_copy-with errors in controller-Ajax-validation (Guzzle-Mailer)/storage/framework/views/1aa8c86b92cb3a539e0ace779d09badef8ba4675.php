                      ...
                      <div class="product_buttons">
                        <div class="text-right d-flex flex-row align-items-start justify-content-start">
                          ...
                          <div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
                            ...
                            <form name="tocart" method="post" action="/tocart" style="display: none;">
                                                  <?php echo e(csrf_field()); ?>

                               <input type="hidden" name="name" value="<?php echo e($product->name); ?>" />
                               <input type="hidden" name="price" value="<?php echo e($product->price); ?>" />
                               <input type="hidden" name="image" value="<?php echo e(asset('public/images/' . $product->image)); ?>" />
                            </form>
                          </div>
                        </div>
                      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('product.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alex/www/laravel-products/resources/views/product/product.blade.php ENDPATH**/ ?>