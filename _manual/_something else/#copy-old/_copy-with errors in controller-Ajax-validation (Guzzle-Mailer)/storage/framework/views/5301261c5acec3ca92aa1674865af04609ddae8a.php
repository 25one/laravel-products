            ...
            <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                ...
                <div class="header_search">
                    <form action="/" id="header_search_form" method="post">
                        ...
                        <button name="hook" type="button" class="header_search_button" value="Search"><img src="<?php echo e(asset('public/images/search.png')); ?>" alt=""></button>
                    </form>
                </div>
               <?php endif; ?>

                <!-- Cart -->
                <div class="cart"><a href="<?php echo e(url('/cart')); ?>"><div><img class="svg" src="<?php echo e(asset('public/images/cart.svg')); ?>" alt="https://www.flaticon.com/authors/freepik"></div></a></div>
                <!-- Phone -->
...
<?php /**PATH /home/alex/www/laravel-products/resources/views/product/layout.blade.php ENDPATH**/ ?>